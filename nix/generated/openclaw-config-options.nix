# Generated from upstream OpenClaw schema at rev 77f145f1dbb4678882b814f7cf3b1f9ca613e51d. DO NOT EDIT.
  ...
  tools = lib.mkOption {
    ...
    web = lib.mkOption {
      ...
      search = lib.mkOption {
        ...
        provider = lib.mkOption {
          type = t.nullOr (t.oneOf [ (t.enum [ "brave" ]) (t.enum [ "firecrawl" ]) (t.enum [ "perplexity" ]) (t.enum [ "grok" ]) (t.enum [ "gemini" ]) (t.enum [ "kimi" ]) ]);
          default = null;
        };
        timeoutSeconds = lib.mkOption {
          type = t.nullOr (t.int);
